  ...
  return (
    <footer className="w-full h-full bg-[#eef6fc]">
      <div className="w-11/12 2xl:w-10/12 mx-auto py-10">
        <div className="bg-[#1f2b5f] gap-y-6 text-white p-5 md:p-8 md:py-8 flex flex-col xl:flex-row shadow-xl justify-between md:items-center rounded-3xl">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-sm">
              Our experts are ready. Get personalized
              <br />
          ...
          <a
            ...
            target="_blank"
            className="flex bg-white border hover:bg-transparent w-fit hover:text-white duration-200 text-secclr h-fit px-5 py-3 rounded-full items-center gap-3 text-sm capitalize font-medium"
          >
        ...
        {/* ================ */}
        <div className="grid text-secclr grid-cols-1 md:grid-cols-3 xl:grid-cols-5 gap-5 gap-y-10 xl:gap-5 pt-20 text-sm">
          <div className=" flex flex-col items-center xl:items-start gap-0">
            <Link to={"/"}>
              <img className="w-40 object-cover" src={Logoh} alt="" />
            </Link>
          ...
          <div className="flex flex-col justify-start gap-4">
            ...
            <ul className="font-semibold flex flex-col gap-2">
              <Link
                to={"/"}
                className="hover:scale-95 hover:underline duration-300"
              >
                Home
              </Link>
              <Link
          ...
          <div className=" flex flex-col justify-start gap-4">
            ...
            <ul className="font-semibold flex flex-col gap-2">
              ...
              <Link
                to={"/intelligent-advisory-portfolios"}
                className="hover:scale-95 hover:underline duration-300"
              >
          ...
          <div className="md:col-span-3 xl:col-span-2 flex flex-col justify-start gap-4">
      ...
      <a
        href="https://api.whatsapp.com/send?phone=917907302020"
        target="_blank"
        className="fixed right-3 bottom-16 bg-secclr border shadow-xl border-white rounded-full w-14 h-14 text-white grid place-items-center"
      >
