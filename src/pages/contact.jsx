    ...
    <>
      <section className="w-11/12 2xl:w-10/12 mx-auto min-h-screen py-20 pt-36 text-secclr">
        <div className="flex flex-col gap-7">
          ...
          <h2
            data-aos="fade-up"
            className="text-3xl text-secclr xl:text-5xl font-bold"
          >
        ...
        <h2
          data-aos="fade-up"
          className="mt-40 mb-10 text-center text-xl text-secclr xl:text-3xl font-bold"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
          {[
            ...
            },
            {
              city: "Malappuram",
              address: [
                "Central Tower Mundupparamba Bypass junction. Malappuram, Kerala, India",
              ],
              phone: "+91 6238 85 20 20",
              tel: "916238852020",
            },
            {
              city: "Manjeri",
              address: [
                "Cap-index enterprises VP mall Manu Memorial Hospital Road, SH24, Melakkam, Manjeri, Kerala 676123",
              ],
                 phone: "+91 8921 49 20 20",
              tel: "918921492020",
            },
            {
              city: "Thrissur",
              address: [
                "Building No. 51/2384-24, at Thoppin Moola, Thrissur- 680004, Kerala, India.",
              ],
              phone: "+91 8848 70 20 20",
              tel: "918848702020",
            },
            {
              city: "Kochi",
            ...
            },
            {
              city: "Banglore",
              address: [
                "Ground Floor, No. 78/9, Outer Ring Road, Bellandur Village Varthur Hobli Bengaluru East, Bengaluru, Karnataka 560103",
              ],
              phone: "+91 8848 71 20 20",
              tel: "918848712020",
            },
          ].map((loc, i) => (
            <div
            ...
            >
              ...
              {loc.phone && (
                <a
                  href={`tel:${loc.tel}`}
                  className="flex w-fit gap-2 items-start hover:opacity-80"
                >
