        ...
        <div className='bg-white'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 xl:gap-x-14'>
              ...
              <div className='flex flex-col justify-center gap-5'>
                  ...
                  <p data-aos="fade-up"  data-aos-delay="150" className='text-base font-normal text-mygray text-justify'>Cap-index Enterprises is a financial hub founded by Mr. Thwayyb Mohiudheen, the Managing Director and CEO, alongside Mr. Hathim Mohammed, the Chairman. Since our establishment in 2019, we have focused on delivering comprehensive financial solutions. Our services include equity trading, commodity trading, portfolio management, mutual fund investments, derivative trading, and insurance, all tailored to meet a variety of financial needs with professionalism. As a premium franchise of Motilal Oswal in India, we pride ourselves on our operational excellence. Our significant client base and dedication to exceptional service reflect our success.</p>
