    ...
    <section className='w-11/12 2xl:w-10/12 mx-auto min-h-screen py-20 pt-32 xl:pt-40 text-secclr'>
        ...
        <div className='py-32'>
            <div className='space-y-3'>
              <h2 className='text-3xl md:text-5xl xl:text-7xl font-black text-center'>Invest in Alternative</h2>
        ...
        <div className='flex flex-col-reverse md:flex-row pt-20'>
          ...
          <div className='basis-1/2 flex flex-col justify-center gap-3'>
            <h2 className='text-2xl xl:text-4xl font-bold capitalize'>what is AIF ?</h2>
            <p className='text-base xl:text-justify'>Alternative Investment Fund or AIF is a privately pooled investment vehicle that invests in alternative asset classes such as private equity, venture capital, hedge funds, real estate, commodities, and derivatives.</p>
          </div>
        </div>

        <div className='py-20'>
            <h3 className='text-2xl xl:text-7xl font-black text-center'>Why <span className='text-prmclr'>AIF</span></h3>
            <div className='grid grid-cols-1 xl:grid-cols-3 gap-5 pt-10'>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  ...
                  <p className='text-sm'>AIFs allow investors to access non-traditional asset classes such as private equity, hedge funds, real estate, commodities, etc., providing greater portfolio diversification.</p>
                </div>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Potential for Higher Returns</h4>
                  <p className='text-sm'>Due to their focus on niche markets and unique investment strategies, AIFs often have the potential to deliver higher returns than conventional investments, albeit with higher risk.</p>
                </div>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Access to Exclusive Opportunities</h4>
                  <p className='text-sm'>AIFs can invest in private companies, venture capital, or specialized sectors that are not typically available through regular markets, offering exposure to high-growth opportunities.</p>
                </div>
            </div>
        </div>
