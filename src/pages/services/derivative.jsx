...
import {metaicon,servbg1,bansamp,ServDerivat} from '../../assets'
    ...
    <section className='w-11/12 2xl:w-10/12 mx-auto min-h-screen py-20 pt-32 xl:pt-40 text-secclr'>
        ...
        <div className='py-32'>
            <div className='space-y-3'>
              <h2 className='text-3xl md:text-5xl xl:text-7xl font-black text-center'>Start Derivative</h2>
              <h2 className='text-3xl md:text-5xl xl:text-7xl font-black text-center text-prmclr'>Trading Today</h2>
            </div>
        ...
        <div className='flex flex-col-reverse md:flex-row pt-20'>
          <div className='basis-1/2'>
            <img className='p-10 object-cover aspect-square' src={ServDerivat} alt="service" />
          </div>
        ...
        <div className='py-20'>
            <h3 className='text-2xl xl:text-7xl font-black text-center'>Why <span className='text-prmclr'>Derivative</span></h3>
            <div className='grid grid-cols-1 xl:grid-cols-3 gap-5 pt-10'>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Hedging</h4>
                  <p className='text-sm'>You are able to safeguard yourself from losses in other investments that function similarly to insurance.</p>
                </div>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Leverage</h4>
                  <p className='text-sm'>Derivatives allow traders to leverage their capital, enabling them to control larger positions with less money and potentially increase their profits.</p>
                </div>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Flexibility</h4>
                  <p className='text-sm'>Derivatives offer a flexible way to tailor your trading strategy to your specific risk tolerance and investment goals.</p>
                </div>
