...
import {metaicon,servbg1,bansamp,ServEquity} from '../../assets'
    ...
    <section className='w-11/12 2xl:w-10/12 mx-auto min-h-screen py-20 pt-32 xl:pt-40 text-secclr'>
        ...
        <div className='py-32'>
            <div className='space-y-3'>
              <h2 className='text-3xl md:text-5xl xl:text-7xl font-black text-center'>Invest in Equity</h2>
              <h2 className='text-3xl md:text-5xl xl:text-7xl font-black text-center '><span className='text-prmclr'>Today</span></h2>
            </div>
        ...
        <div className='flex flex-col-reverse md:flex-row pt-20'>
          <div className='basis-1/2'>
            <img className='p-10 object-cover aspect-square' src={ServEquity} alt="service" />
          </div>
        ...
        <div className='py-20'>
            <h3 className='text-2xl xl:text-7xl font-black text-center'>Why <span className='text-prmclr'>Equity</span></h3>
            <div className='grid grid-cols-1 xl:grid-cols-3 gap-5 pt-10'>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Potential for High Returns</h4>
                  <p className='text-sm'>Equities have the potential to offer significantly higher returns compared to other investment options like bonds or fixed deposits. Historically, stock markets have shown long-term growth, making equities an attractive option for wealth creation.</p>
                </div>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Liquidity</h4>
                  <p className='text-sm'>Equities offer high liquidity, allowing investors to buy and sell shares on stock exchanges quickly and easily. This flexibility enables investors to enter and exit positions based on market conditions, making equities a convenient investment option.</p>
                </div>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Ownership and Dividends</h4>
