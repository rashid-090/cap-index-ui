    ...
    <section className='w-11/12 2xl:w-10/12 mx-auto min-h-screen py-20 pt-32 xl:pt-40 text-secclr'>
        ...
        <div className='py-20'>
            <div className='space-y-3'>
              <h2 className='text-3xl md:text-5xl xl:text-7xl font-black text-center'>Start <span className='text-prmclr'>Portfolio</span></h2>
              <h2 className='text-3xl md:text-5xl xl:text-7xl font-black text-center '><span className='text-prmclr'>Management Services</span></h2>
              <h2 className='text-3xl md:text-5xl xl:text-7xl font-black text-center '>Today</h2>
            </div>
        ...
        <div className='flex flex-col-reverse md:flex-row pt-20'>
          ...
          <div className='basis-1/2 flex flex-col justify-center gap-3'>
            <h2 className='text-2xl xl:text-4xl font-bold capitalize'>what is Portfolio Management Services ?</h2>
            <p className='text-base xl:text-justify'>Portfolio Management Services (PMS) offer tailored investment solutions to high-net-worth individuals (HNIs). PMS involves a professional fund manager who manages your investments based on your financial goals and risk profile.</p>
          </div>
        </div>

        <div className='py-20'>
            <h3 className='text-2xl xl:text-7xl font-black text-center'>Why <span className='text-prmclr'>Portfolio<br/> Management Services</span></h3>
            <div className='grid grid-cols-1 xl:grid-cols-3 gap-5 pt-10'>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Customized Investment Strategies</h4>
                  <p className='text-sm'>PMS allows for personalized investment strategies tailored to individual financial goals, risk tolerance, and preferences.</p>
                </div>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Professional Management</h4>
                  <p className='text-sm'>Investments are managed by experienced portfolio managers with deep expertise, aiming to maximize returns.</p>
                </div>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Transparency</h4>
                  <p className='text-sm'>PMS offers full transparency as clients can track the performance of their portfolios and know the underlying securities.</p>
                </div>
            </div>
        </div>
