    ...
    <section className='w-11/12 2xl:w-10/12 mx-auto min-h-screen py-20 pt-32 xl:pt-40 text-secclr'>
        ...
        <div className='py-32'>
            <div className='space-y-3'>
              <h2 className='text-3xl md:text-5xl xl:text-7xl font-black text-center'>Invest in Intelligent</h2>
              <h2 className='text-3xl md:text-5xl xl:text-7xl font-black text-center '><span className='text-prmclr'>Advisory</span> Portfolios</h2>
            </div>
        ...
        <div className='flex flex-col-reverse md:flex-row pt-20'>
         <div className='basis-1/2'>
          ...
          <div className='basis-1/2 flex flex-col justify-center gap-3'>
            <h2 className='text-2xl xl:text-4xl font-bold capitalize'>what is IAPs ?</h2>
            <p className='text-base xl:text-justify'>Intelligent Advisory Portfolios (IAPs) are pre-designed innovative investment solutions, curated to simplify equity market investing for those who don’t have time to stop and invest.</p>
          </div>
        </div>

        <div className='py-20'>
            <h3 className='text-2xl xl:text-7xl font-black text-center'>Why Investing in <span className='text-prmclr'>IAPs</span></h3>
            <div className='grid grid-cols-1 xl:grid-cols-3 gap-5 pt-10'>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Personalized Investment Strategy</h4>
                  <p className='text-sm'>Offers customized portfolio recommendations based on individual goals, risk tolerance, and financial needs, ensuring a tailored investment approach.</p>
                </div>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Data-Driven Insights</h4>
                  <p className='text-sm'>Utilizes advanced algorithms and data analytics to provide real-time insights and recommendations, optimizing portfolio performance.</p>
                </div>
                <div className='bg-white shadow-xl p-7 rounded-3xl hover:shadow-2xl duration-200 flex flex-col gap-2'>
                  <h4 className='text-xl font-extrabold'>Diversified Portfolio</h4>
